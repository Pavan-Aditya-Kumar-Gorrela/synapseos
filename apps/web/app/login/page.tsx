...
import { Cpu, Eye, EyeOff, ShieldCheck, HelpCircle } from 'lucide-react';
...
export default function AuthenticationWorkspace() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('System Authentication Sequence Initialized', { email, securityKey, trustTerminal });
  };
  ...
  return (
    <div className="min-h-screen bg-[#0e1323] text-[#dee1f9] font-sans selection:bg-[#2fd9f4]/20 flex flex-col lg:flex-row relative overflow-hidden antialiased">
      ...
      {/* GLOBAL BACKGROUND GLOW FIELDS (Neural Firing Effects) */}
      ...
      {/* --- LEFT BRANDING PANEL --- */}
      {/* Changed justify-between to gap-y-12 to remove forced edge-to-edge stretching */}
      <div className="w-full lg:w-[55%] p-8 sm:p-12 lg:p-24 flex flex-col justify-start gap-y-12 relative min-h-fit lg:min-h-screen">
        ...
        {/* Central Core Value Statement - Removed my-auto to eliminate massive dynamic padding */}
        ...
        {/* Lower System Micro-Telemetry Footers - Removed mb-40 and fixed invalid white template literal */}
      ...
      <div className="w-full lg:w-[45%] p-4 sm:p-8 lg:p-24 flex items-center justify-center bg-[#080d1d]/30 border-l border-white/[0.04] backdrop-blur-[10px]">
        ...
        {/* Authentication Card (Level 2 Floating Canvas Strategy) */}
        <div className="w-full max-w-md bg-[#161b2b]/40 border border-white/[0.08] rounded-2xl p-8 backdrop-blur-[30px] shadow-[0_24px_60px_rgba(8,13,29,0.7)] relative group transition-all duration-300 hover:border-white/[0.12]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative rounded-lg bg-[#080d1d]/60 border border-white/[0.08] focus-within:border-[#4d8eff] transition-colors duration-200">
                <input
                  ...
                  className="w-full h-11 bg-transparent px-3 text-sm text-[#dee1f9] placeholder-[#424754] focus:outline-none pr-10"
                />
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <label htmlFor="securityKey" className="text-[10px] font-semibold tracking-[0.2em] text-[#94A3B8] uppercase">
                  Security Key
                </label>
                <a href="#recovery" className="text-xs text-[#94A3B8] hover:text-[#adc6ff] transition-colors font-light">
                  Forgot password?
                </a>
              </div>
              <div className="relative rounded-lg bg-[#080d1d]/60 border border-white/[0.08] focus-within:border-[#4d8eff] transition-colors duration-200">
                <input
                  ...
                  placeholder="••••••••••••"
                  className="w-full h-11 bg-transparent px-3 text-sm text-[#dee1f9] placeholder-[#424754] focus:outline-none pr-10 font-mono tracking-widest"
                />
                <button
                  type="button"
            ...
            {/* Field: Machine Trust Agreement Checkbox */}
            ...
            {/* Action Element: Primary Core Execution Submission */}
            <button
              type="submit"
              className="w-full h-11 rounded-lg bg-gradient-to-r from-[#adc6ff] to-[#4d8eff] hover:opacity-95 text-[#00285d] font-semibold text-xs tracking-[0.1em] uppercase shadow-[0_0_30px_rgba(173,198,255,0.2)] hover:shadow-[0_0_35px_rgba(173,198,255,0.3)] transition-all active:scale-[0.99] mt-2 flex items-center justify-center gap-2"
            >
          ...
          {/* Auxiliary Authentication Providers Grid */}
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 h-10 rounded-lg bg-[#080d1d]/40 border border-white/[0.08] hover:bg-[#080d1d]/80 hover:border-[#424754] text-xs text-[#dee1f9] font-medium transition-all duration-150">
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
                ...
                <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1C7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" />
              </svg>
              <span>Google</span>
            </button>
            <button className="flex items-center justify-center gap-2 h-10 rounded-lg bg-[#080d1d]/40 border border-white/[0.08] hover:bg-[#080d1d]/80 hover:border-[#424754] text-xs text-[#dee1f9] font-medium transition-all duration-150">
              <svg className="w-3.5 h-3.5 text-[#424754] group-hover:text-[#94A3B8]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
          ...
          {/* Core System Request Terminal Anchor */}
